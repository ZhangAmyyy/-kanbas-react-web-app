...
// const COURSES_URL = " https://kanbas-node-server-app-qyrs.onrender.com/api/courses"
// const ASSIGNMENTS_URL = "http://localhost:4000/api/assignments";
// const ASSIGNMENTS_URL = "https://kanbas-node-server-app-qyrs.onrender.com/api/assignments";
...
export const findAssignmetsForCourse = async (courseId) => {
  const response = await axios
